...
def cleandata(dataset, keepcolumns=['Country Name', '1990', '2015'], value_variables=['1990', '2015']):
    ...
    top10country = ['United States', 'China', 'Japan', 'Germany', 'United Kingdom', 'India',
...
# fourth chart shows rural population vs arable land
    ...
    for country in countrylist:
        ...
        text = []
        for country1, year in zip(country_label, year):
            text.append(str(country1) + ' ' + str(year))
    ...
    figures = [dict(data=graph_one, layout=layout_one), dict(data=graph_two, layout=layout_two),
               dict(data=graph_three, layout=layout_three), dict(data=graph_four, layout=layout_four),
